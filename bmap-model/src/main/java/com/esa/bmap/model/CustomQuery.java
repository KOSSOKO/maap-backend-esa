...
public class CustomQuery {
	 ...
	 * 
	 * @param tableName Target table for the query.
	...
	/**
	 * @param joinedTablesList The joinedTablesList to set.
	 */
	 ...
	 * 
	 * @param tableName The joined table to be added to the list
	 * @throws BmapException When the specified string did not pass the security
	 *             checks.
	 */
	 ...
	 * 
	 * @param criteria The criteria to be added to the list.
	 * @throws BmapException When the specified string did not pass the security
	 *             checks.
	 */
	 ...
	 * 
	 * @param list The list of strings from which to build the string of values.
