...
public class Data {
	 ...
	 */
	@Column(name = "bmaapUserID", nullable = true)
	private Long bmaapUserID = null;
	...
	/**
	 * @return the bmaapUserID
	 */
	public Long getBmaapUserID() {
		return bmaapUserID;
	}

	/**
	 * @param bmapUserID the bmapUserID to set
	 */
	public void setBmaapUserID(Long bmaapUserID) {
		this.bmaapUserID = bmaapUserID;
	}
