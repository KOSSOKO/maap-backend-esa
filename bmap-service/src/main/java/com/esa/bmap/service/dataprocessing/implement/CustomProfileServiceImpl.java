...
@Service(value = "CustomProfileServiceInterface")
public class CustomProfileServiceImpl implements CustomProfileServiceInterface {
	...
	public String getCustomProfile(String granuleId, String wkt) throws BmapException {
		...
		return this.dataProcessingService.getCustomProfile(pythonDataDir + "/" + sep[0] + "/" + sep[1], wkt);
	}
