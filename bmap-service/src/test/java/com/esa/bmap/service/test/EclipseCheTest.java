...
public class EclipseCheTest {
	...
	public void getToken() throws ClientProtocolException, IOException {
		...
		HttpUriRequest request = RequestBuilder.post()
				...
				.addParameter("username", "kosted")
				.addParameter("client_id", "che-public")
				.addParameter("password", "Dok:;753")
		...
		try {
			...
			//On fait une la requete qui permet de récupérer les workspaces de l'utilisateur
