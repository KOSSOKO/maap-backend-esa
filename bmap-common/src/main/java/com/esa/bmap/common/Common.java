...
public class Common {
	 ...
	 * Messages 
	 */
	public static final String FILE_NOT_FOUND_ERROR = "errorMessage.fileNotFound";
	public static final String INGEST_PRIVATE_DATA_PARAMETERS = "GroundCampaignReaderServiceImpl.ingestPrivateData";
