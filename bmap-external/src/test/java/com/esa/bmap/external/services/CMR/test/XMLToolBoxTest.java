...
public class XMLToolBoxTest {
	 ...
	 * 
	 */
	public void testLoadXMLFromFile() throws BmapException {
	 ...
	 */
	public void testValidateGranuleXML() throws BmapException {
	 ...
	 */
	public void testConvertStringToDocument() throws BmapException {
	 ...
	 */
	public void testGetTagNameTextContentFromXML() throws BmapException {
		Granule granule = new Granule();
		granule = granuleInit.initGranulePolarisation(granule);
		Document doc = jaxbService.createDocXMLFromGranule(granule);
