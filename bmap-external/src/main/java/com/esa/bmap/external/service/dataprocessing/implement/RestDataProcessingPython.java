package com.esa.bmap.external.service.dataprocessing.implement;
...
public class RestDataProcessingPython implements DataProcessingInterface {
	...
	public String getRoiSubsetStats(String granuleRasterId, String granuleRoiId) throws BmapException {
		...
		try {
			...
			Map<String, String> map = new HashMap<String, String>();
			map.put(PARAMETER_RASTER_PATH, granuleRasterId);
			map.put(PARAMETER_SHAPEFILE_PATH, granuleRoiId);
			ObjectMapper mapper = new ObjectMapper();
			String jsonFromMap = mapper.writeValueAsString(map);
