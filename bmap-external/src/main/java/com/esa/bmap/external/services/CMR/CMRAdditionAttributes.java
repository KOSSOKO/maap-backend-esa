...
public interface CMRAdditionAttributes {
	...
	/**
	 * Online Resource WMS URL
	 */
	static final String ONLINE_RESOURCE_VISUALIZATION_TYPE="VisualizationURL";
	static final String ONLINE_RESOURCE_VISUALIZATION_DESCRIPTION="WMS GetMap Resource";
