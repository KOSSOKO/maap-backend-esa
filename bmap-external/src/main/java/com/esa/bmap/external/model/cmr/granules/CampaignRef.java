...
/**
 * This entity contains attributes describing
 ...
 *       experiments, etc. Seems to be a reference to one that exists
 *       at collection level.
 * 
 * <p>Classe Java pour CampaignRef complex type.
 * 
 * <p>Le fragment de sch�ma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="CampaignRef">
 *   &lt;complexContent>
...
@XmlType(name = "CampaignRef", propOrder = {
    "shortName"
})
public class CampaignRef {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CampaignRef other = (CampaignRef) obj;
		if (shortName == null) {
	...
	public String toString() {
		return "CampaignRef [shortName=" + shortName + "]";
	}
