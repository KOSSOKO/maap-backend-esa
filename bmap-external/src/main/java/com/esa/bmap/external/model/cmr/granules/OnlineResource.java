...
/**
 * This entity records the documentation
 * 				information of the collection including documentation type
 * 				and documentation URL where apply etc.
 * 
 * <p>Classe Java pour OnlineResource complex type.
 * 
 * <p>Le fragment de sch�ma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="OnlineResource">
 *   &lt;complexContent>
...
@XmlType(name = "OnlineResource", propOrder = {
    "url",
    "description",
    "type",
    "mimeType"
...
public class OnlineResource {
	...
	public String toString() {
		return "OnlineResource [url=" + url + ", description=" + description + ", type=" + type + ", mimeType="
				+ mimeType + "]";
	}
