...
/**
 * A reference to a sensory subcomponent in
 *       the parent collection's instrument used by various sources in
 *       this granule. A sensor reference may contain characteristics
 *       specific to the granule. These characteristics are not
 *       checked against the referenced sensor.
 * 
 * <p>Classe Java pour SensorRef complex type.
 * 
 * <p>Le fragment de sch�ma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="SensorRef">
 *   &lt;complexContent>
...
@XmlType(name = "SensorRef", propOrder = {
    "shortName",
    "characteristics"
})
public class SensorRef {
	...
	public String toString() {
		return "SensorRef [shortName=" + shortName + ", characteristics=" + characteristics + "]";
	}
