...
public class VisualisationController {
	...
	@Resource
	private RasterStatisticsServiceInterface rasterStatisticsServiceInterface;
	...
	public String getRasterBasicStats(@PathVariable(value = "id") String granuleId) throws BmapException {
		...
		return this.rasterStatisticsServiceInterface.getRasterBasicStats(sep[0] + "/" + sep[1]).toString();
	}
	...
	public String getRasterSubsetStats(@RequestBody GranuleWktSubset granuleWktSubset) throws BmapException {
		...
		return this.rasterStatisticsServiceInterface.getSubsetStats(granuleWktSubset.getGranuleID(),
	...
	public String getRasterRoiSubsetStats(@RequestBody GranuleRoiSubset granuleRoiSubset) throws BmapException {
		...
		return this.rasterStatisticsServiceInterface.getRoiSubsetStats(granuleRoiSubset.getGranuleRaster(),
	...
	public String getCustomProfile(@RequestBody GranuleWktSubset granuleWktSubset) throws BmapException {
		...
		return this.profileServiceInterface.getCustomProfile(granuleWktSubset.getGranuleID(),
				granuleWktSubset.getWkt());
	}
